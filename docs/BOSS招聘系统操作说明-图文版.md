...
| 运行控制 | 连接浏览器、选择岗位、设置滚动轮次和筛选完成后的处理方式 |
...
启动成功后，窗口左下角会显示当前版本号，例如 `v2.23.3`。
...
- **推荐候选人**：65 分及以上，且没有人工确认或 AI 评估失败的候选人。发送待核实属于沟通状态，不改变原筛选分类，但会阻止重复加入联系清单。
