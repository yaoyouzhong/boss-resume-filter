...
DOM_SCROLL_DELAY_CENTER = 2.75     # DOM 扫描滚动间隔中心值（秒），默认约 1.5-4 秒
DOM_SCROLL_DELAY_SPREAD = 2.5      # DOM 扫描滚动间隔随机抖动范围（秒）
DOM_SCROLL_BATCH_MIN = 5           # DOM 扫描长暂停最小滚动轮数
DOM_SCROLL_BATCH_MAX = 10          # DOM 扫描长暂停最大滚动轮数
DOM_SCROLL_BATCH_PAUSE_CENTER = 11.5  # DOM 扫描长暂停中心值（秒），默认约 8-15 秒
DOM_SCROLL_BATCH_PAUSE_SPREAD = 7.0   # DOM 扫描长暂停随机抖动范围（秒）
MAX_SCROLL_SEARCH = 40             # 最大滚动搜索次数
MAX_ROUNDS_DEFAULT = 50            # 默认最大扫描轮数
...
API_PAGE_DELAY_CENTER = 5.0        # API 分页直调间隔中心值（秒），默认约 3-7 秒
API_PAGE_DELAY_SPREAD = 4.0        # API 分页直调随机抖动范围（秒）
API_CANDIDATE_LIMIT_DEFAULT = 160  # API 结构化补全预算，默认最多补全 8 页
GREET_CONTEXT_CAPTURE_LIMIT = 15   # 打招呼上下文捕获上限
GREET_CONTEXT_MIN_SCORE = SCORE_THRESHOLD_RECOMMEND  # 打招呼上下文捕获最低推荐分
GREET_CONTEXT_DELAY_CENTER = 4.0   # 打招呼上下文捕获单人间隔中心值（秒），默认约 3-5 秒
GREET_CONTEXT_DELAY_SPREAD = 2.0   # 打招呼上下文捕获单人间隔随机抖动范围（秒）
GREET_CONTEXT_BATCH_SIZE = 3       # 打招呼上下文捕获批次大小
GREET_CONTEXT_BATCH_PAUSE_CENTER = 8.0  # 打招呼上下文捕获批次暂停中心值（秒），默认约 6-10 秒
GREET_CONTEXT_BATCH_PAUSE_SPREAD = 4.0  # 打招呼上下文捕获批次暂停随机抖动范围（秒）
