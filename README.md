...
> 当前发布版本：v2.33.3 证书识别与截图体验优化（版本号 v2.33.3）
...
**体验优化**
- **升级提醒**：发现新版本时，首页显示绿色升级图标，鼠标悬停查看提示，点击后打开升级窗口，减少操作打扰。
- **更新体验**：后台定期检查新版本，可开启空闲时自动下载；关闭升级窗口不影响下载，重启后保留更新提醒和安装包，安装前由用户确认。

**问题修复**
- **证书图片支持**：恢复 WebP 格式证书图片的正常打开和识别。
