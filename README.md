...
> 当前发布版本：v2.16 AI 评估体系升级（版本号 v2.16）
...
- **简历评估替代一次评估**：导入完整简历后，二次评估直接替代一次评估的调整值（不再累加），以简历评估结果为准

**体验优化**

- **简历维度评分替代显示**：有简历评估时，详情弹窗的维度评分展示简历二次评估结果，替代一次评估的维度分数
