...
> 当前发布版本：v2.15.1 一键 AI 评估（版本号 v2.15.1）
...
- **一键 AI 评估**：筛选结果页右键支持单个候选人 AI 评估、多个候选人批量 AI 评估（只适用未 AI 评估过的候选人）
- **数据统计看板批量 AI 评估**：按岗位/按时间明细窗口多选右键菜单增加批量 AI 评估
